...
import { setFilter } from "../store/analyticsSlice";
...
function LogAnalyticsHeader(props) {
  ...
  return (
    <div className="flex flex-col sm:flex-row flex-1 w-full space-y-8 sm:space-y-0 items-center justify-between pb-32 pt-24 px-24 md:px-64">
      <Typography className="flex text-24 md:text-36">Log Analytics</Typography>
      <LogFilter
...
export default LogAnalyticsHeader;
